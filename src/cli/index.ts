...
import { describeAction, renderBoard, renderPlayer, renderScoreboard } from './render.js';
import { loadFromFile, replay, saveToFile, type SavedGame } from './game-log.js';
...
const isMainModule = process.argv[1]?.endsWith('cli/index.ts') || process.argv[1]?.endsWith('cli/index.js');
if (isMainModule) {
