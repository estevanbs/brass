 ...
 * Not part of `nx test` — it is a slow, one-off validation script. Run with:
 *   npx tsx client/tools/run-random-batch.ts [gamesPerPlayerCount]
 */
import { runBatch, randomBot } from '../libs/backend-infrastructure/src/index.js';
import type { PlayerId } from '../libs/backend-domain/src/index.js';
