...
import { INDUSTRY_TYPES } from '../../src/lib/core/types.js';
import { FARM_BREWERIES, INDUSTRIAL_LOCATIONS, MARKETS } from '../../src/lib/rules/board-data.js';
import { initialIndustryStock } from '../../src/lib/rules/industry-data.js';
